...
def arg_setting():
    ...
    parser.add_argument('--cuda',      type=str, default='1',               help='select GPU ID')
    parser.add_argument('--exp',       type=str, default='_benchmark',      help='output exp results')
    ...
    parser.add_argument('--method',    type=str, default='protonet',      help='Few-shot classification algorithm')
    ...
    parser.add_argument('--SPF', action='store_true', help='activate SPF module or do not')
    parser.add_argument('--SCIp', action='store_true', help='activate SCI module or do not')
    parser.add_argument('--CIFp', action='store_true', help='activate CIF module or do not')
    ...
    parser.add_argument('--emb_dims', type=int,  default=1024,   help='dim of output global feature')
    parser.add_argument('--fine_grained', action='store_true',   help='save features for visualization')
